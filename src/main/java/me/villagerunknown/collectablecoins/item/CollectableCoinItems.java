...
public class CollectableCoinItems {
	...
	static {
		COLLECTABLE_COPPER_CAT_COIN = CollectableCoinFeature.registerCraftableCollectableCoinItem( Villagercoin.MOD_ID,"collectable_copper_cat_coin", CollectableCoinFeature.COPPER_VALUE, CoinFeature.COPPER_RARITY, CollectableCoinFeature.COPPER_DROP_CHANCE, 1, 1, 1, CoinFeature.COPPER_FLIP_CHANCE, CollectableCoinFeature.COPPER_MAXIMUM_IN_CIRCULATION, Set.of(BuiltInLootTables.VILLAGE_PLAINS_HOUSE,BuiltInLootTables.VILLAGE_DESERT_HOUSE,BuiltInLootTables.VILLAGE_SAVANNA_HOUSE,BuiltInLootTables.VILLAGE_SNOWY_HOUSE,BuiltInLootTables.VILLAGE_TAIGA_HOUSE,BuiltInLootTables.FISHING_TREASURE), Set.of( EntityTypes.CAT) );
		COLLECTABLE_COPPER_CHICKEN_COIN = CollectableCoinFeature.registerCraftableCollectableCoinItem( Villagercoin.MOD_ID,"collectable_copper_chicken_coin", CollectableCoinFeature.COPPER_VALUE, CoinFeature.COPPER_RARITY, CollectableCoinFeature.COPPER_DROP_CHANCE, 1, 1, 1, CoinFeature.COPPER_FLIP_CHANCE, CollectableCoinFeature.COPPER_MAXIMUM_IN_CIRCULATION, Set.of(BuiltInLootTables.VILLAGE_FLETCHER), Set.of(EntityTypes.CHICKEN) );
		COLLECTABLE_COPPER_CREEPER_COIN = CollectableCoinFeature.registerCraftableCollectableCoinItem( Villagercoin.MOD_ID,"collectable_copper_creeper_coin", CollectableCoinFeature.COPPER_VALUE, CoinFeature.COPPER_RARITY, CollectableCoinFeature.COPPER_DROP_CHANCE, 1, 1, 1, CoinFeature.COPPER_FLIP_CHANCE, CollectableCoinFeature.COPPER_MAXIMUM_IN_CIRCULATION, Set.of(BuiltInLootTables.JUNGLE_TEMPLE,BuiltInLootTables.DESERT_PYRAMID,BuiltInLootTables.DESERT_PYRAMID_ARCHAEOLOGY,BuiltInLootTables.DESERT_WELL_ARCHAEOLOGY), Set.of(EntityTypes.CREEPER) );
		COLLECTABLE_COPPER_SHEEP_COIN = CollectableCoinFeature.registerCraftableCollectableCoinItem( Villagercoin.MOD_ID,"collectable_copper_sheep_coin", CollectableCoinFeature.COPPER_VALUE, CoinFeature.COPPER_RARITY, CollectableCoinFeature.COPPER_DROP_CHANCE, 1, 1, 1, CoinFeature.COPPER_FLIP_CHANCE, CollectableCoinFeature.COPPER_MAXIMUM_IN_CIRCULATION, Set.of(BuiltInLootTables.VILLAGE_SHEPHERD), Set.of(EntityTypes.SHEEP) );
		COLLECTABLE_COPPER_IRON_GOLEM_COIN = CollectableCoinFeature.registerCraftableCollectableCoinItem( Villagercoin.MOD_ID,"collectable_copper_iron_golem_coin", CollectableCoinFeature.COPPER_VALUE, CoinFeature.COPPER_RARITY, CollectableCoinFeature.COPPER_DROP_CHANCE, 1, 1, 1, CoinFeature.COPPER_FLIP_CHANCE, CollectableCoinFeature.COPPER_MAXIMUM_IN_CIRCULATION, Set.of(BuiltInLootTables.VILLAGE_ARMORER,BuiltInLootTables.PILLAGER_OUTPOST), Set.of(EntityTypes.IRON_GOLEM) );
		COLLECTABLE_COPPER_WOLF_COIN = CollectableCoinFeature.registerCraftableCollectableCoinItem( Villagercoin.MOD_ID,"collectable_copper_wolf_coin", CollectableCoinFeature.COPPER_VALUE, CoinFeature.COPPER_RARITY, CollectableCoinFeature.COPPER_DROP_CHANCE, 1, 1, 1, CoinFeature.COPPER_FLIP_CHANCE, CollectableCoinFeature.COPPER_MAXIMUM_IN_CIRCULATION, Set.of(BuiltInLootTables.TRIAL_CHAMBERS_REWARD_RARE), Set.of(EntityTypes.WOLF) );
		COLLECTABLE_COPPER_ZOMBIE_COIN = CollectableCoinFeature.registerCraftableCollectableCoinItem( Villagercoin.MOD_ID,"collectable_copper_zombie_coin", CollectableCoinFeature.COPPER_VALUE, CoinFeature.COPPER_RARITY, CollectableCoinFeature.COPPER_DROP_CHANCE, 1, 1, 1, CoinFeature.COPPER_FLIP_CHANCE, CollectableCoinFeature.COPPER_MAXIMUM_IN_CIRCULATION, Set.of(BuiltInLootTables.ANCIENT_CITY), Set.of(EntityTypes.ZOMBIE) );
		...
		COLLECTABLE_IRON_CHICKEN_COIN = CollectableCoinFeature.registerCraftableCollectableCoinItem( Villagercoin.MOD_ID,"collectable_iron_chicken_coin", CollectableCoinFeature.IRON_VALUE, CoinFeature.IRON_RARITY, CollectableCoinFeature.IRON_DROP_CHANCE, 1, 1, 1, CoinFeature.IRON_FLIP_CHANCE, CollectableCoinFeature.IRON_MAXIMUM_IN_CIRCULATION, Set.of(BuiltInLootTables.VILLAGE_FLETCHER), Set.of(EntityTypes.CHICKEN) );
